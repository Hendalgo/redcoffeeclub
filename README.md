...
En m�vil, la preparaci�n conserva una escala de c�mara estable y ajusta el encuadre contra los l�mites proyectados del AeroPress y la taza, con 16 px de margen. El ajuste entra gradualmente al terminar la transici�n para evitar un salto al recortar el canvas. `scripts/brew-frame-qa.mjs` comprueba 1.446 poses en seis tama�os de pantalla, incluido el recorrido de armado.
