...
En dos de cada tres paradas, el autoplay gira la camisa central tras 2,55 o 2,9 segundos de reposo. Alterna la dirección y varía la duración del giro entre 950 y 1170 ms según el modelo. Después deja 3,4 segundos para ver la otra cara antes de avanzar; las paradas sin giro conservan la espera de 5,5 segundos. Cada parada permite un solo giro automático y un giro manual cuenta como la revelación de esa parada. Los giros automáticos y el avance se pausan con el botón, el foco, el puntero, durante el arrastre, al salir de pantalla o al ocultar la pestaña. Los giros pausados se reanudan desde su ángulo actual. Con movimiento reducido, la selección y la cara cambian inmediatamente y se desactiva el avance automático. Sin JavaScript quedan seis vistas frontales en una galería con desplazamiento nativo; los botones de giro se ocultan.
